-- ===========================================================================
-- ★ 2026-09-24 이관됨 — 이 파일은 더 이상 스키마 정본이 아니다. 실행하지 말 것.
-- ===========================================================================
-- mart 뷰·함수와 upa_* 표 구조는 backend Alembic 이 만든다:
--   backend/alembic/versions/0028_adopt_upa_tables.py   (upa_* 표 5종)
--   backend/alembic/versions/0029_create_mart_views.py  (이 파일의 고정본)
-- 뷰를 바꾸려면 backend 에 새 리비전(CREATE OR REPLACE VIEW)을 추가한다.
-- 이 파일을 고쳐 DB 에 직접 돌리면 Alembic 이 모르는 변경이 생긴다.
-- 본문은 설계 근거(각 절 주석)를 참고하도록 남겨 둔다.
-- ===========================================================================
